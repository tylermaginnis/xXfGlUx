  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <section className="container mx-auto px-4 py-20">
        <h2 className="text-3xl font-bold mb-4 text-center">Your Digital Membership Card</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-4xl mx-auto mb-20">
